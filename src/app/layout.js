...
export const metadata = {
    metadataBase: new URL('https://msk-endo.vercel.app'),
    title: 'Эндопротезирование суставов — лечение и госпитализация',
    description: 'Операции при артрозе и травмах суставов. Подбор клиники и хирурга, организация госпитализации в Москве без длительного ожидания.',
    ...
    other: {
        ['yandex-verification']: 'fa567654cab5e249',
    },
    openGraph: {
        ...
        url: 'https://msk-endo.vercel.app',
        type: 'website',
        locale: 'ru_RU',
    },
    alternates: {
        canonical: 'https://msk-endo.vercel.app',
    }
};
